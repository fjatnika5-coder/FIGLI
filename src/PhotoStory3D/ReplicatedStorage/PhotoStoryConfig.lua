...
Config.Scenes = {
	{
		...
		GirlPoint  = "GirlPoint",
		BoyPoint   = "BoyPoint",
		Camera     = { FOV = 45, PhotoMode = true, Shake = false, ShakeAmount = 0, SlowZoom = true, ZoomAmount = 1.2 },
		Animations = { Girl = "rbxassetid://94236640546781", Boy = "rbxassetid://97440045770691",
			GirlPoseTime = 0.8, BoyPoseTime = 0.8, FreezePose = true },
		Text = {
	...
	},
	{
		...
		GirlPoint  = "GirlPoint",
		BoyPoint   = "BoyPoint",
		Camera     = { FOV = 50, PhotoMode = true, Shake = false, ShakeAmount = 0, SlowZoom = true, ZoomAmount = 1.2 },
	...
	},
	{
		...
		GirlPoint  = "GirlPoint",
		BoyPoint   = "BoyPoint",
		Camera     = { FOV = 40, PhotoMode = true, Shake = false, ShakeAmount = 0, SlowZoom = true, ZoomAmount = 1.2 },
		Animations = { Girl = "rbxassetid://77338301055587", Boy = "rbxassetid://77338301055587",
			GirlPoseTime = 0.6, BoyPoseTime = 0.6, FreezePose = true },
		Text = {
